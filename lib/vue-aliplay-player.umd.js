...
// CONCATENATED MODULE: ./packages/vue-aliplay-player/src/player.vue?vue&type=template&id=799bf928&
    ...
    initAliplayer: function initAliplayer(url) {
      ...
      if (_this.scriptTagStatus === 2 && source) {
        ...
        _this.$nextTick(function () {
          ...
          _this.instance.on('playing', function () {
            // console.log('playing');
            _this2.$emit('playing', _this.instance);
          });
